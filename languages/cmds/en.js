module.exports = {
	...
	help: {
		...
		text: {
			...
			roleText2: "2 (VIP users)",
			roleText3: "3 (Bot admins)",
			roleText4: "4 (Owner only)",
			roleText0setRole: "0 (set role, all users)",
			roleText1setRole: "1 (set role, group administrators)",
			roleText2setRole: "2 (set role, VIP users)",
			roleText3setRole: "3 (set role, bot admins)",
			roleText4setRole: "4 (set role, owner only)",
